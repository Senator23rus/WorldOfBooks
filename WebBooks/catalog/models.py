...
class Author(models.Model):
    ...
    last_name = models.CharField(max_length=100, help_text="Input family name author", verbose_name="Author family name")
...
class Book(models.Model):
    ...
    genre = models.ForeignKey('Genre', on_delete=models.CASCADE, help_text=" Choose genre of the book", verbose_name="Genre of book", null=True)
    language = models.ForeignKey('Language', on_delete=models.CASCADE, help_text=" Choose language of the book", verbose_name="Language of book", null=True)
    author = models.ManyToManyField('Author', help_text=" Choose author of the book", verbose_name="Author of book")
    summary = models.TextField(max_length=1000, help_text="Input summary of the book", verbose_name="Short text of the book")
...
class BookInstance(models.Model):
    ...
    inv_num = models.CharField(max_length=20, null=True,help_text="Input inentary number", verbose_name="Inventary humber")
    inprint = models.CharField(max_length=200, help_text="Input publishing and year", verbose_name="Publishing")
    status = models.ForeignKey('Status', on_delete=models.CASCADE, null=True, help_text="Change status exemplar", verbose_name="Status exemplar")
